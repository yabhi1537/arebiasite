...
<div class="card-body mt-0">
    ...
    <form id="baseForm" name="baseForm" class="forms-sample" method="POST"
        action="{{ route('banner.update',$data->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <input type="hidden" value="{{$data->bannerImg}}" name="image">

        <div class="form-group">
            <label for="title">Banner Title</label>
            <input type="text" class="form-control required" value="{{$data->title}}" id="title" placeholder="Name"
                name="title">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{$data->title_ar}}" class="form-control required" id="title_ar"
                placeholder="Name" name="title_ar">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control required" placeholder="Enter text here..."
                name="description_ar"> {{$data->description_ar}}</textarea>
        ...
        <div class="form-group">
            ...
            <input type="url" class="form-control required" id="to_date" value="{{$data->link}}" placeholder="url"
                name="link" />
