...
<div class="card-body mt-0">
    ...
    <form autocomplete="off" id="baseForm" name="baseForm" class="forms-sample" method="POST" action="{{ route('marketer.store')}}"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="email" placeholder="Name" name="email">
        ...
        <div class="form-group">
            ...
            <div id="datepicker-popups" class="input-group date datepicker">
                <input type="text" class="form-control" placeholder="date" name="join_date">
