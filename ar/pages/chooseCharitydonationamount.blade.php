          ...
          <div class="panel">
            <div class="card" style="width: auto ;">
                <div class="card-body">
                  ...
                  <p class=" mt-3 panel_titleDetail">نوع المشروع :</p>
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row mt-3 wiseBtn detailss_Btn">   
                      <p class="panel_titleDetail mt-1"> سيتم الخصم من حسابك مقابل:</p>
                       <div class="col-3 p-0"><button type="button" data-interval="180" class="btn w-100 BTN-1 active rounded-0 intervaldays">6 اشهر</button></div>
                       <div class="col-3 p-0"><button type="button" data-interval="90" class="btn w-100 BTN-2 rounded-0 intervaldays">3 اشهر</button></div>
                       <div class="col-3 p-0"><button type="button" data-interval="60" class="btn w-100 BTN-2 rounded-0 intervaldays">2 أشهر</button></div>
                       <div class="col-3 p-0"><button type="button" data-interval="30" class="btn w-100 BTN-2 rounded-0 intervaldays">شهر</button></div>
                    </div>
                  ...
                  <div class="row mt-3">   
                    <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="opencardmodal()"> تبرع الآن</button></div>
                ...
                <div class="panel mt-3">
                    ...
                    <a href="{{route('choosecharityDonation',[app()->getLocale(), $charitydeductionproject->project_code ] )}}">
                       <img src="../../uploads/projectimage/{{ $charitydeductionproject->image }}" class="card-img-top d-block w-100 " alt="...">
                        ...
                        <div class="card-body">
                        <a href="{{route('choosecharityDonation',[app()->getLocale(), $charitydeductionproject->project_code ] )}}">
                            <h6 class=" mt-1 card-title"> {{ $charitydeductionproject->project_name_ar }} </h6>
                        </a>
                            
                            <h6 class="CLR text-center mt-3">نوع المشروع :</h6>
                            <div class="row">
                            <div class="col-md-12">
                            ...
                            <h6 class="CLR text-center mt-1"> سيتم الخصم من حسابك مقابل:</h6>
                                  <div class="col-3 p-0"><button type="button" id="6_month_{{$key}}" data-interval_{{$key}}="180" class="btn w-100 BTN-2 active rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'6_month_{{$key}}')">6 اشهر</button></div>
								   <div class="col-3 p-0"><button type="button" id="3_month_{{$key}}" data-interval_{{$key}}="90"  class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'3_month_{{$key}}')">3 اشهر</button></div>
								   <div class="col-3 p-0"><button type="button" id="2_month_{{$key}}" data-interval_{{$key}}="60" class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'2_month_{{$key}}')">2 أشهر</button></div>
								   <div class="col-3 p-0"><button type="button" id="month_{{$key}}" data-interval_{{$key}}="30" class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'month_{{$key}}')">شهر</button></div>
										</div>
                          ...
                          <div class="row text-center mt-3">
                            ...
                            <div class="row mt-3">   
                            <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="opencardmodalall({{$key}})"                                                          >تبرع الآن <i class="fa-solid fa-money-bill-wave"></i></button></div>
                            </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="text-center heaD">
                  <h5 class="">بيانات الدفع</h5>
                  <img src="../../assets/img/vm.png">
                </div>
                <div class="Payment_form">
                  <div class="row mt-4 ">
                    <label class="form-label text-center">رقم البطاقة</label>
                    <div class="input-group mb-3">
                      <span class="input-group-text"><i class="bi bi-credit-card"></i></span>
                      <input type="number" class="form-control login_email" required maxlength="16"  name="cardnumber" id="cardnumber"  placeholder="أدخل رقم البطاقة">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">تاريخ الانتهاء</label>
                    <div class="col-md-6">
                      <input type="number" class="form-control login_email" required maxlength="2"  name="expiry_year" id="expiry_year"  placeholder="السنة">
                    </div>
                    <div class="col-md-6">
                      <input type="number" class="form-control login_email" required maxlength="2" name="expiry_month" id="expiry_month"   placeholder="الشهر">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">CVC مدونة</label>
                    <div class="col-md-12">
                      <input type="number" class="form-control login_email" required maxlength="3" name="cvc_code" id="cvc_code"  placeholder="رمز التحقق من البطاقة">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">صاحب بطاقة</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control login_email" required name="card_owner" id="card_owner"   placeholder="اسم مالك البطاقة">
                    </div>
                  </div>
                  
                  @if($loginuser) 
                   <div class="row mt-1 ">
                    <label class="form-label text-center">اسم المتبرع</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control login_email"  name="donor_name" id="donor_name"   placeholder="اسم المتبرع" value="{{ $loginuser->full_name}}">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">بريد إلكتروني</label>
                    <div class="col-md-12">
                      <input type="email" class="form-control login_email" id="donor_email" name="donor_email"   placeholder="بريد إلكتروني" value="{{ $loginuser->email}}">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">رقم التليفون</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control login_email"  id="donor_phone" name="donor_phone"   placeholder="رقم التليفون" value="{{ $loginuser->phone}}">
                  ...
                  <div class="row mt-1 ">
                    <label class="form-label text-center">اسم المتبرع</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control login_email"  name="donor_name" id="donor_name"   placeholder="اسم المتبرع">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">بريد إلكتروني</label>
                    <div class="col-md-12">
                      <input type="email" class="form-control login_email" id="donor_email" name="donor_email"   placeholder="بريد إلكتروني">
                    </div>
                  </div>
                  <div class="row mt-1 ">
                    <label class="form-label text-center">رقم التليفون</label>
                    <div class="col-md-12">
                      <input type="text" class="form-control login_email"  id="donor_phone" name="donor_phone"   placeholder="رقم التليفون">
              ...
              <div class="modal-footer">
                <button type="submit" class="btn BTN-1 w-100">تبرع الآن</button>
              </div>
