      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$contactusheader->title_ar}}</h1>
            <p class=" mb-5">{{$contactusheader->description_ar}}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-8 mt-3">
        <div class="row box justify-content-center mt-4">
           <div class="col-md-12 ">
            <h2 class="mt-2 text-center" style="font-size: 26px; font-weight: 700; color: #5d5d5d;">اتصل بنا</h2>
			...
			@endif
              <div class="row mt-4 ">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control login_email" name="fullname" id="fullname"  placeholder="الاسم الكامل">
                ...
                <div class="col-md-6">
                  <div class="input-group mb-3 mt-3">
                    ...
                    <input type="text" class="form-control login_pass" name="phonenumber" id="phonenumber"   placeholder="رقم التليفون">
                ...
                <div class="col-md-6">
                  <div class="input-group mb-3 mt-3 ">
                    ...
                    <input type="text" class="form-control login_pass" name="email" id="email"   placeholder="بريد إلكتروني">
                    @if ($errors->has('email'))
                ...
                <div class="input-group mb-3 mt-3">
                  <textarea class="form-control px-3" name="querie" id="querie" rows="3" placeholder="اتصل بنا للاستفسارات"></textarea>
