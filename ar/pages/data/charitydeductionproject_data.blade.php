                        ...
                        <a href="{{route('choosecharityDonation',[app()->getLocale(), $charitydeductionproject->project_code ] )}}">
                            ...
                            <h6 class="CLR text-center mt-1"> سيتم الخصم من حسابك :</h6>
                                  <div class="col-3 p-0"><button type="button" id="6_month_{{$key}}" data-interval_{{$key}}="180" class="btn w-100 BTN-2 active rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'6_month_{{$key}}')">6 شهور</button></div>
								   ...
								   <div class="col-3 p-0"><button type="button" id="month_{{$key}}" data-interval_{{$key}}="30" class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'month_{{$key}}')">شهور</button></div>
										</div>
