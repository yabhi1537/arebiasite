                ...
                <div class="panel">
                  <div class="card" style="width: auto ;">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $constructionproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(), $constructionproject->project_code ] )}}">
                          <h6 class=" mt-1 CLR ">{{ $constructionproject->project_name_ar }} </h6>
                        </a>
                        ...
                        <div class="row card-title borderd mt-3 cardAmountDetails pt-2">
                          <div class="col-4 borderRight ">
                              ...
                              <p class="m-0">{{ number_format($constructionproject->target_amount) }} د.ك </p>
                          </div>
                          <div class="col-4 borderRight">
                              <h6 class="mt-1"><span>التبرعات</span> </h6>
                              <p class="m-0">{{ number_format($constructionproject->donated) }} د.ك </p>
                          </div>
                          <div class="col-4">
                              <h6 class="mt-1"><span>المتبقية</span> </h6>
                              <p class="m-0">{{ number_format($constructionproject->residual) }} د.ك </p>
                          </div>
                        </div>
                        ...
                        <div class="row mt-3">   
                           <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($constructionproject->project_id)] )}}','constructionproject_number_{{$key}}')"  class="btn w-100 BTN-1"> تبرع الآن</button></div>
