                ...
                <div class="panel">
                  <div class="card" style="width: auto ;">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $developmentalsocialproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(), $developmentalsocialproject->project_code ] )}}">
                          <h6 class=" mt-1 CLR ">{{ $developmentalsocialproject->project_name_ar }} </h6>
                        </a>
                        ...
                        <div class="row card-title borderd mt-3 cardAmountDetails pt-2">
                          <div class="col-4 borderRight ">
                              ...
                              <p class="m-0">{{ number_format($developmentalsocialproject->target_amount) }} د.ك </p>
                          </div>
                          <div class="col-4 borderRight">
                              <h6 class="mt-1"><span>التبرعات</span> </h6>
                              <p class="m-0">{{ number_format($developmentalsocialproject->donated) }} د.ك </p>
                          </div>
                          <div class="col-4">
                              <h6 class="mt-1"><span>المتبقية</span> </h6>
                              <p class="m-0">{{ number_format($developmentalsocialproject->residual) }} د.ك </p>
                          </div>
                        </div>
                        ...
                        <div class="row mt-3">   
                           <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($developmentalsocialproject->project_id)] )}}','developmentalsocialproject_number_{{$key}}')"  class="btn w-100 BTN-1"> تبرع الآن</button></div>
