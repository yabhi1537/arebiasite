  ...
  <section id="FAQ" class="FAQ ">
    <div class="container">
      <div class="row sectionHeading my-5">
        <h1 class="text-center CLR">التعليمات</h1>
          ...
          <div class="FAQ_List align-items-start">
            <div class="col-md-3">
              <div class="nav nav-pills FAQ_List_arange me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button class="nav-link active" id="v-pills-projects-tab" data-bs-toggle="pill" data-bs-target="#v-pills-projects" type="button" role="tab" aria-controls="v-pills-projects" aria-selected="true">المشاريع</button>
                <button class="nav-link" id="v-pills-guarantees-tab" data-bs-toggle="pill" data-bs-target="#v-pills-guarantees" type="button" role="tab" aria-controls="v-pills-guarantees" aria-selected="false">ضمانات</button>
                <button class="nav-link" id="v-pills-dedications-tab" data-bs-toggle="pill" data-bs-target="#v-pills-dedications" type="button" role="tab" aria-controls="v-pills-dedications" aria-selected="false">الإهداءات</button>
                <button class="nav-link" id="v-pills-deductions-tab" data-bs-toggle="pill" data-bs-target="#v-pills-deductions" type="button" role="tab" aria-controls="v-pills-deductions" aria-selected="false">الخصومات</button>
              </div>
            </div>
            <div class="col-md-9">
