      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$sponsershipsheader->title}}</h1>
            <p class=" mb-5">{{$sponsershipsheader->description}}</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="sponsorShip" class="container mt-5">
    <div class="sponsorShip " style="margin:0 auto; width: 96%;">
      <div class="row sectionHeading mb-3">
        <h1 class="text-center CLR">Sponsorship</h1>
        ...
        <div class="col-md-4">
          <div class="img_Box text-center">
            <a href="#">
              ...
              <h6 class="text-center CLR mt-3">Teacher</h6>
            </a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="img_Box text-center">
            <a href="#">
              ...
              <h6 class="text-center CLR mt-3">Hafez</h6>
            </a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="img_Box text-center">
            <a href="#">
              ...
              <h6 class="text-center CLR mt-3">Hafez (orphan)</h6>
            </a>
          </div>
        </div>
      </div>
         ...
         <div class="col-md-4 block4">
            <div class="box p-3">
               <div class="row">
                  ...
                  <div class="col-7">
                     <div class="details text-end">
                        <p class="CLR mb-1">Name / {{ $sponsership->name }}</p>
                        <p class="mb-1">Age: <span>{{ $sponsership->age }}</span> years</p>
                        @if($sponsership->gender == 1)
                        <p class="mb-1">Gender: Male</p>
                        @else
                        <p class="mb-1">Gender: Female</p>
                        @endif
                        <p class="mb-1">Type: {{ $sponsership->sponser_type }}</p>
                        <p class="mb-1 mt-3 CLR">{{ $sponsership->country }}  <span> <img src="../assets/img/kw.png" class="flag_img"></span></p>
                     </div>
                  </div>
               ...
               <div class=" row mt-3 justify-content-center">   
                <div class="col-4 "><button type="button" class="btn w-100 BTN-1" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($sponsership->id)] )}}','sponserprice_{{$key}}')" >Sponsor</button></div>
          ...
          <div class="mt-5">
            <button type="button" id="load4"  class="btn w-100 BTN-1">More</button>
          </div>
