      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$zakatheader->title}}</h1>
            <p class=" mb-5">{{$zakatheader->description}}</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="zakatCalculator" class="container mt-5 mb-5">
  <div class="mediaReports ">
    <div class=" sectionHeading mb-3">
      <h1 class="text-center CLR">Zakat Calculator</h1>
    </div>
    <!-- -----Tab start----- -->
    <div class="row">
      <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
		 <li class="nav-item me-2" role="presentation">
            <button class="nav-link BTN-1 active" id="moneyZakat-tab" data-bs-toggle="pill" data-bs-target="#pills-moneyZakat" type="button" role="tab" aria-controls="pills-moneyZakat" aria-selected="false"> Money Zakat</button>
        </li> 
        <li class="nav-item me-2" role="presentation">
          <button class="nav-link BTN-1" id="shareZakat-tab" data-bs-toggle="pill" data-bs-target="#pills-shareZakat" type="button" role="tab" aria-controls="pills-shareZakat" aria-selected="true"> Shares Zakat</button>
        </li>
        <li class="nav-item me-2" role="presentation">
          <button class="nav-link BTN-1" id="metalZakat-tab" data-bs-toggle="pill" data-bs-target="#pills-metalZakat" type="button" role="tab" aria-controls="pills-metalZakat" aria-selected="false"> Metal Zakat</button>
        </li>
        <li class="nav-item me-2" role="presentation">
          <button class="nav-link BTN-1" id="goldZakat-tab" data-bs-toggle="pill" data-bs-target="#pills-goldZakat" type="button" role="tab" aria-controls="pills-goldZakat" aria-selected="false"> Gold Zakat</button>
        </li>
                ...
                <div class="col-md-11">
                  ...
                  <div class="panel mt-3">
                      <div class="card" style="width: auto ;">
                          <div class="card-body">
                            <label class="CLR mt-3 mb-2">The value</label>
                              <div class="mb-2">
                              ...
                              <label class="CLR mt-2 mb-2">Type of zakat</label>
                              <select class="form-select f-14" id="txtzakatdrp_0" name="txtzakatdrp_0" onchange="ValidateSelect('0')">
                                  <option value="" selected>Select the type of Zakat</option>
                                  <option value="501">Cash</option>
                                  <option value="502">Bank cash savings accounts</option> 
                                  <option value="503">Bank cash current account</option>
                                  <option value="504">Cash in frozen deposits</option>
                              </select>
                               <span id="txtzakatdrp_error_0" class="text-danger bold"></span>
                              <div class="row mt-4">   
                              <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="CalcZakat('0','Money Zakat','bbdd234345')">Calculate your intelligence</button></div>
                              </div>
                    ...
                    <div class="card" style="width: auto ;">
                        <div class="card-body">
                           ...
                           <select class="form-select f-14" id="txtzakatdrp_1" name="txtzakatdrp_1" onchange="ValidateSelect('1')">
                              <option value="" selected>Select the type of Zakat</option>
                              <option value="601">Personal loans</option>
							  <option value="602">Government bonds</option> 
							  <option value="603">Bonds</option>
							  <option value="604">Shares</option>
							  <option value="605">Investments in companies</option>
							   <option value="606">Other sources of income</option>
                            </select>
                            <span id="txtzakatdrp_error_1" class="text-danger bold"></span>
                            <div class="row mt-4">   
                             <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="CalcZakat('1','Share Zakat','bbdd234346')">Calculate your intelligence</button></div>
                            </div>
                      ...
                      <div class="card" style="width: auto ;">
                          <div class="card-body">
                            <label class="CLR mt-3 mb-2">The value</label>
                              ...
                              <label class="CLR mt-3 mb-2">Type of zakat</label>
                              <select class="form-select f-14" id="txtzakatdrp_2" name="txtzakatdrp_2" onchange="ValidateSelect('2')">
                                  <option selected>Select the type of Zakat</option>
                                  <option value="701">Silver</option>
                                  <option value="702">Platinum</option>
                             
                              </select>
                              <span id="txtzakatdrp_error_1" class="text-danger bold"></span>
                              <div class="row mt-3">   
                              <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="CalcZakat('2','Metal Zakat','bbdd234347')">Calculate your intelligence</button></div>
                              </div>
                      ...
                      <div class="card" style="width: auto ;">
                          <div class="card-body">
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                    <h5 class="CLR mt-3 mb-2 text-center">21 Karat Gold</h5>
                                    <div class="col-md-4">
                                        <label class="CLR mt-3 mb-2">Weight :</label>
                                 ...
                                 <div class="row">
                                    <h5 class="CLR mt-3 mb-2 text-center">18 Karat Gold</h5>
                                    <div class="col-md-4">
                                        <label class="CLR mt-3 mb-2">Weight :</label>
                              ...
                              <div class="row mt-4">   
                                <div class="col-12"><button onclick="CalcGoldZakat(1,'Zakat on gold','bbdd234348')" type="button" class="btn w-100 BTN-1">Calculate your intelligence</button></div>
                              </div>
			...
			<div class="col-md-11">
			  <div class="panel mt-3">
				<div class="card border-0" style="width: auto ;">
					 <h4 class="text-center mb-4 mt-4">Values ​​of zakat</h4>
					<div class="card-body  table-responsive">
				       ...
				       <div class="row border-top py-3 mx-2 table-zakat-amount">
						 <div class="col-md-7 text-center"><h6 class="m-0">Total zakat</h6></div>
						...
						<div class="row mt-4">   
						  <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt(10)] )}}','total_zakat_donation')" >DONATION</button></div>
						</div>
 ...
 <script>
  ...
  function CalcZakat(index, zakatName, typeId) {
        ...
        if (txtVal === "" && (drp != undefined && drp.value === "")) {
            $(`#txtzakatcalc_error_${index}`).html("Please enter the value");
            $(`#txtzakatdrp_error_${index}`).html("Please enter the value");
            return;
        }
    ...
    function CalcGoldZakat(index, zakatName, typeId) {
        ...
        if (txtVal0 <= 0 && txtVal1 <= 0 && txtVal2 <= 0 && txtVal3 <= 0) {
              $(`#txtzakatcalc_error_gold`).html("Required value");
              return;
        }
