            ...
            <div class="card" style="width: auto ;">
                <div class="card-body">
                  ...
                  <div class="row mt-4">
                   ...
                   <div class="row mt-4">
                  <div class="col-12"><a href="{{route('zakat',app()->getLocale())}}" class="btn BTN-1 w-100">Calculate your Zakat</a></div>  
                   </div>
                  <div class="row mt-4 donar_detailForm">
                      
					@if($loginuser) 
					  <div class="mb-3">	 
                        <input type="text" class="form-control" id="donor_name" name="donor_name" placeholder="Donor Name" value="{{ $loginuser->full_name}}">
                      </div>
                      <div class="col-md-6">
                       <input type="text" class="form-control" id="donor_phone" name="donor_phone"  placeholder="Donor Phone" value="{{ $loginuser->phone}}">
                      </div>
                      <div class="col-md-6">
                        <input type="email" class="form-control" id="donor_email" name="donor_email"  placeholder="Donor Email" value="{{ $loginuser->email}}">
                      </div>
                        @else
                      <div class="mb-3">	 
                        <input type="text" class="form-control" id="donor_name" name="donor_name" placeholder="Donor Name" value="">
                      </div>
                      <div class="col-md-6">
                       <input type="text" class="form-control" id="donor_phone" name="donor_phone"  placeholder="Donor Phone" value="">
                      </div>
                      <div class="col-md-6">
                        <input type="email" class="form-control" id="donor_email" name="donor_email"  placeholder="Donor Email" value="">
                      </div>         
                    @endif
                  </div>
                  ...
                  <div class="row mt-3">   
                    ...
                    <div class="col-8"><button type="submit" class="btn w-100 BTN-1" > Donate Now</button></div>
