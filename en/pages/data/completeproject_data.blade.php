                  ...
                  <div class="card" style="width: auto ;">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $completeproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        ...
                        <!--<div class="row mt-3">   
                          <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($completeproject->project_id)] )}}','completeproject_number_{{$key}}')"  class="btn w-100 BTN-1"> Donate Now</button></div>
