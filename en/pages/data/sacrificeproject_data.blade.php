                ...
                <div class="panel">
                  <div class="card" style="width: auto ;">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $sacrificeproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(), $sacrificeproject->project_code ] )}}">
                          <h6 class=" mt-1 CLR ">{{ $sacrificeproject->project_name }} </h6>
                        </a>
                        ...
                        <div class="row card-title borderd mt-3 cardAmountDetails pt-2">
                          <div class="col-4 borderRight ">
                              ...
                              <p class="m-0">{{ number_format($sacrificeproject->target_amount) }} KD </p>
                          </div>
                          <div class="col-4 borderRight">
                              <h6 class="mt-1"><span>Donations</span> </h6>
                              <p class="m-0">{{ number_format($sacrificeproject->donated) }} KD </p>
                          </div>
                          <div class="col-4">
                              <h6 class="mt-1"><span>Residual</span> </h6>
                              <p class="m-0">{{ number_format($sacrificeproject->residual) }} KD </p>
                          </div>
                        </div>
                        ...
                        <div class="row mt-3">   
                           <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($sacrificeproject->project_id)] )}}','sacrificeproject_number_{{$key}}')"  class="btn w-100 BTN-1"> Donate Now</button></div>
