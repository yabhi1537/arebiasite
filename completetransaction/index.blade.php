    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-3">
                <h4 class="card-title mb-0">Complete Transaction</h4>
            ...
            <div class="fillterDrpdown">
                <div class="">
                    ...
                    <div class="row justify-content-end mt-3 mr-2">
                        ...
                        <div class="col-md-2 p-1 ">
                            <a href="{{ route('completetransaction') }}"
            ...
            <div id="projectlist">
                @include('admin.completetransaction.data')
            </div>
        </div>
    </div>
</div>
...
function getdata(page = 0) {
    ...
    $.ajax({
        url: "{{ route('completetransaction') }}?page=" + page,
        type: "GET",
        data: {
            'p_type': p_type,
            'category': category,
...
function getdata_pdf() {
    ...
    $.ajax({
        url: "{{ route('completetransactionPDF', 'pdf') }}",
        type: "GET",
        data: {
            'p_type': p_type,
            'from_date': from_date,
...
function getdata_excel() {
    ...
    $.ajax({
        url: "{{ route('completetransactionExport', ['excel','xlsx']) }}",
        type: "GET",
        data: {
            'p_type': p_type,
            'from_date': from_date,
