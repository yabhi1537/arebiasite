...
<div class="card-body mt-0">
    ...
    <form autocomplete="off" id="baseForm" name="baseForm" class="forms-sample" method="POST" action="{{ route('country.store')}}"
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="country" placeholder="Name" name="country">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="short_name" placeholder="Name" name="short_name">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="latitude" placeholder="Name" name="latitude">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control required" id="longitude" placeholder="Name" name="longitude">
