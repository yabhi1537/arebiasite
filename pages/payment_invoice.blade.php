                  ...
                  <div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav nav-tabs tab-solid tab-solid-primary mb-0" id="myTab" role="tablist">
                     ...
                     <li class="nav-item">
                       ...
                       <li class="nav-item">
                        <a class="nav-link" id="security-tab" data-toggle="tab" href="#security" role="tab" aria-controls="security"> المبلغ المتبرع به :{{$transaction->donate_amount}} د.ك</a>
                      </li>
                    </ul>
                  </div>
                  <div class="wrapper">
