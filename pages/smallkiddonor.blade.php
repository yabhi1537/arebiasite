      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$smallkiddonorheader->title_ar}}</h1>
            <p class=" mb-5">{{$smallkiddonorheader->description_ar}}</p>
          </div>
        </div>
      </div>
    </div> 
...
<section id="mediaReports" class="container mt-5">
  <div class="mediaReports ">
    <div class="row sectionHeading">
      <h1 class="text-center CLR">متبرع طفل صغير</h1>
         ...
         <div class="panel mt-3">
          <div class="card" style="width: auto ;">
            <a href="{{route('chooseDonation',[app()->getLocale(), $smallkidsproject->project_code ] )}}">
              ...
              <div class="card-body">
               <a href="{{route('chooseDonation',[app()->getLocale(), $smallkidsproject->project_code ] )}}">
                 <h6 class=" mt-1 card-title">{{ $smallkidsproject->project_name_ar }}</h6>
               </a>
                  ...
                  <div class="row mt-3">  
					   <div class="col-12"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($smallkidsproject->project_id)] )}}','smallkidsproject_number_{{$key}}')"  class="btn w-100 BTN-1"> تبرع الآن <i class="fa-solid fa-money-bill-wave"></i></button></div>
