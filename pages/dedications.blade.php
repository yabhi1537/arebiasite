...
<form class="gift-form" method="post" id="giftdonation-form" autocomplete="off" action="{{ route('myfatoorah.dedication_request',app()->getLocale())}}">
    ...
    <div class="">
        <div class="row">
            ...
            <div class="col-10 col-sm-11 p-0">
                <div class="gift_headbox-2 p-2 px-3">
                    <h5 class="m-0" style="font-size: 20px; font-weight: 700; color: #1a6b48;">اختر المشروع</h5>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="panel mt-4">
                    <div class="card" style="width: auto ;">
                        ...
                        <div class="card-body">
                            <h6 class=" mt-1 card-title" style="font-size: 15px;"> {{ $dedicationproject->project_name_ar }}</h6>
        ...
        <div class="row mt-4">
            ...
            <div class="col-10 col-sm-11 p-0">
                <div class="gift_headbox-2 p-2 px-3">
                    <h5 class="m-0" style="font-size: 20px; font-weight: 700; color: #1a6b48;">اختيار القالب</h5>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="col-5 col-sm-2 text-center mt-4">
                    <h1 class="BTN-1">بطاقات</h1>
                </div>
            </div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-10 col-sm-11 p-0">
                <div class="gift_headbox-2 p-2 px-3">
                    <h5 class="m-0" style="font-size: 20px; font-weight: 700; color: #1a6b48;">معلومات المتلقي</h5>
                </div>
            </div>
            <div class=" p-3">
                ...
                <div class="row mt-3 donar_detailForm">
                  <div class="mb-4">
                    <label for="exampleFormControlInput1" class="form-label">اختر نوع التبرع</label>
                    <select class="form-select required" name="donation_type" id="donation_type" aria-label="Default select example">
                      <option value="" selected>عيادة المريض</option>
                      <option value="أخت">الى اختي</option>
                      <option value="أخ">إلى أخي</option>
                      <option value="زوجة">إلى زوجتي</option>
                       <option value="زوج">لزوجي</option>
                       <option value="صديق">إلى صديقي</option>
                       <option value="أب">إلى والدي</option>
                       <option value="الأم">إلى أمي</option>
                    </select>
                  </div>
                  
                  <div class="mb-4">
                    <label for="exampleFormControlInput1" class="form-label">مبلغ التبرع</label>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label class="form-label">اسم من أهدي إليه
                      </label>
                  ...
                  <div class="col-md-6">
                    <div class="mb-4">
                      <label class="form-label">اسم المرسل
                      </label>
                  ...
                  <div class="mb-4">
                    <label class="form-label">عنوان البريد الإلكتروني للمستلم</label>
                ...
                <div class="row mt-3 donar_detailCheckbox">
                    ...
                    <ul>
                        <li>
                            ...
                            <label for="flexRadioDefault1"><img src="../assets/img/kn.png"/><span>كي نت</span></label>
                        </li>
                        <li>
                            <input class="form-check-input" type="radio" id="flexRadioDefault2" name="paymentmethode_id" value="2" style="display: none;" />
                            <label for="flexRadioDefault2"><img src="../assets/img/vm.png"/><span>تأشيرة / ماجستير</span></label>
                        </li>
                        @if($loginuser) 
                         <li>
                          <input class="form-check-input" type="radio" id="flexRadioDefault3" name="paymentmethode_id" value="3" style="display: none;" />
                         <label class="form-check-label" for="flexRadioDefault3" style="font-size: 19px;"><i class="fa-solid fa-wallet"></i><span>WALLET ({{$loginuser->wallet_balance}} د.ك)</span></label>
                        </li>
                       @endif
                    </ul>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <button type="button" onclick="previewGiftDonation();"  class="btn BTN-1 p-2 w-100 mt-3"> معاينة</button>
                  </div>
                  <div class="col-md-6">
                    <button type="button" onclick="submitGiftDonation();"  class="btn BTN-1 p-2 w-100 mt-3"> يُقدِّم</button>
                  </div>
                </div>
