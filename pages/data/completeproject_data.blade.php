                      ...
                      <div class="card-body">
                        ...
                        <div class="row card-title borderd mt-3 cardAmountDetails pt-2">
                          <div class="col-4 borderRight ">
                              ...
                              <p class="m-0">{{ number_format($completeproject->target_amount) }} د.ك </p>
                          </div>
                          <div class="col-4 borderRight">
                              <h6 class="mt-1"><span>التبرعات</span> </h6>
                              <p class="m-0">{{ number_format($completeproject->donated) }} د.ك </p>
                          </div>
                          <div class="col-4">
                              <h6 class="mt-1"><span>المتبقية</span> </h6>
                              <p class="m-0">{{ number_format($completeproject->residual) }} د.ك </p>
                          </div>
                        </div>
                        ...
                        <!--<div class="row mt-3">   
                          <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($completeproject->project_id)] )}}','completeproject_number_{{$key}}')"  class="btn w-100 BTN-1"> تبرع الآن</button></div>
