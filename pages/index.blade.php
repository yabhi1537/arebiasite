...
<div id="carouselExampleRide" class="carousel slide" data-bs-ride="true">
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h1 class="animate__animated animate__fadeInDownBig" style="animation-duration: 2s;">{{ $banner->title_ar }}</h1>
        <p class="animate__animated animate__fadeInDownBig" style="animation-duration: 2s;">{{ $banner->description_ar }}</p>
        <button type="button" class="btn btn-primary BTN-1 animate__animated animate__backInUp" style="animation-duration: 2s;">أساسي</button>
      </div>
    </div>
    @else
    ...
    @empty
     <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h1 class="animate__animated animate__fadeInDownBig" style="animation-duration: 2s;">بلا عنوان</h1>
        <p class="animate__animated animate__fadeInDownBig" style="animation-duration: 2s;">بدون وصف</p>
        <button type="button" class="btn btn-primary BTN-1 animate__animated animate__backInUp" style="animation-duration: 2s;">أساسي</button>
      </div>
    </div>
    @endforelse
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleRide" data-bs-slide="prev">
    ...
    <span class="visually-hidden">أساسي</span>
  </button>
...
<section id="zakatHome" class="">
  ...
  <div class=" sectionHeading mb-4" >
    <h1 class="text-center CLR" data-aos="fade-left" data-aos-duration="2000">مشروع الزكاة</h1>
    <p class="text-center" data-aos="fade-right" data-aos-duration="2000">لوريم إيبسوم هو ببساطة نص وهمي من صناعة الطباعة والتنضيد</p>
  </div>
    <div class="row mt-4 w-95" data-aos="fade" data-aos-duration="1000" data-aos-delay="100">
        <div class="detailS-1 col-md-9 BG ">
            <div class="detailS">
                <h2>{{$zakatproject->title_ar}}</h2>
                <p class="mt-1">{!!$zakatproject->description_ar!!}</p>
             ...
             <div class="d-flex col-md-6">
                ...
                <div class="row mt-3 " >   
                  <div class="col-md-3"><button type="button" class="btn w-100 BTN-1"  onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($zakatproject->project_id)] )}}','zakatproject_number')" > تبرع الآن</button></div>
                  ...
                  <div class="col-md-4 offset-md-2"><a href="{{route('zakat',app()->getLocale())}}" class="btn BTN-1 w-100">احسب زكاتك</a></div>
                </div> 
            </div>
        </div>
    ...
    <div class="row">
      <div class="table-responsive p-0" data-aos="flip-up" data-aos-duration="2000" data-aos-delay="100">
        <table class="table ">
          <thead class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
            <tr>
              <th scope="col-5" class="nav-item" role="presentation"><button class="nav-link active" id="pills-completed-tab" data-bs-toggle="pill" data-bs-target="#pills-completed" type="button" role="tab" aria-controls="pills-completed" aria-selected="true">مشاريع جديدة</button></th>
              <th scope="col"class="nav-item" role="presentation"><button class="nav-link" id="pills-seasonal-tab" data-bs-toggle="pill" data-bs-target="#pills-seasonal" type="button" role="tab" aria-controls="pills-seasonal" aria-selected="false">المشاريع التي تحتاج إلى الدعم</button></th>
              <th scope="col" class="nav-item" role="presentation"><button class="nav-link" id="pills-permanent-tab" data-bs-toggle="pill" data-bs-target="#pills-permanent" type="button" role="tab" aria-controls="pills-permanent" aria-selected="false">المشاريع المنجزة</button></th>
            </tr>
          </thead>
        </table>
      </div>
      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-completed" role="tabpanel" aria-labelledby="pills-completed-tab" tabindex="0">
          <div class="row">
                ...
                <div class="panel" data-aos="fade" data-aos-duration="2000">
                  <div class="card">
                    <a href="{{route('chooseDonation',[app()->getLocale(),$newproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(), $newproject->project_code ])}}">
                          <h6 class=" mt-1 CLR ">{{ $newproject->project_name_ar }} </h6>
                        </a>
                        ...
                        <div class="row mt-3">   
                          <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($newproject->project_id)] )}}','newproject_number_{{$key}}')" class="btn w-100 BTN-1"> تبرع الآن</button></div>
           ...
           <div class="text-center mt-5">
            <a href="#" id="load" class="btn BTN-1">أكثر <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
          </div>
        </div>
        <!-- ---- Tab-2 ----- -->
        <div class="tab-pane fade" id="pills-seasonal" role="tabpanel" aria-labelledby="pills-seasonal-tab" tabindex="0">
                ...
                <div class="panel" data-aos="fade" data-aos-duration="2000">
                  <div class="card">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $needsupportproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(),$needsupportproject->project_code] )}}">
                          <h6 class=" mt-1 CLR ">{{ $needsupportproject->project_name_ar }} </h6>
                        </a>
                        ...
                        <div class="row mt-3">   
                          <div class="col-6"><button type="button" onclick="donatenow('{{route('addproduct.to.cart',[app()->getLocale(), encrypt($needsupportproject->project_id)] )}}','needsupport_number_{{$key}}')"  class="btn w-100 BTN-1"> تبرع الآن</button></div>
          ...
          <div class="text-center mt-5">
            <a href="#" id="load2" class="btn BTN-1">أكثر <i class="fa-solid fa-arrow-up-right-from-square"></i></a>
          </div>
                ...
                <div class="panel" data-aos="fade" data-aos-duration="2000">
                  <div class="card">
                    <a href="{{route('chooseDonation',[app()->getLocale(), $completeproject->project_code ] )}}">
                      ...
                      <div class="card-body">
                        <a href="{{route('chooseDonation',[app()->getLocale(), $completeproject->project_code ] )}}">
                          <h6 class=" mt-1 CLR ">{{ $completeproject->project_name_ar }} </h6>
                        </a>
...
<!-- ====================== Projectsection End ===================== -->
 ...
 <!-- ======================= Blog/News Start ====================== -->
  ...
  <div class="sectionHeading mb-4 mt-3">
    <h1 class="text-center CLR" data-aos="fade-down" data-aos-duration="1000">أخبار الموقع</h1>
    <p class="text-center" data-aos="fade-up" data-aos-duration="1000">لوريم إيبسوم هو ببساطة نص وهمي من صناعة الطباعة والتنضيد</p>
  </div>
  <div class="container">
...
<script type="text/javascript">
    ...
    $(document).ready(function () { 
            ...
            $("#load").on("click", function (e) { 
                ...
                if ($(".block:hidden").length == 0) { 
                    $("#load").text("لا يوجد المزيد للعرض") 
                        .fadOut("slow"); 
                } 
            }); 
        })
    ...
    $(document).ready(function () { 
            ...
            $("#load2").on("click", function (e) { 
                ...
                if ($(".block2:hidden").length == 0) { 
                    $("#load2").text("لا يوجد المزيد للعرض") 
                        .fadOut("slow"); 
                } 
            }); 
        })  
     ...
     $(document).ready(function () { 
            ...
            $("#load3").on("click", function (e) { 
                ...
                if ($(".block3:hidden").length == 0) { 
                    $("#load3").text("لا يوجد المزيد للعرض") 
                        .fadOut("slow"); 
                } 
            }); 
        })  
