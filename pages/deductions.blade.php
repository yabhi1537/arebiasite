...
<!-- ========================= hero section start ======================= -->
  <div id="aboutHero">
    <div  class="bsb-hero-1 px-3 bsb-overlay bsb-hover-pull" style="background-image:url('/uploads/deductiontitleimage/{{$deductionsheader->image}}');">
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$deductionsheader->title_ar}}</h1>
            <p class=" mb-5">{{$deductionsheader->description_ar}}</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="mediaReports" class="container mt-5">
  <div class="mediaReports ">
    <div class="row sectionHeading">
      <h1 class="text-center CLR">الخصومات</h1>
                    ...
                    <a href="{{route('choosecharityDonation',[app()->getLocale(),$charitydeductionproject->project_code ] )}}">
                       <img src="../uploads/projectimage/{{ $charitydeductionproject->image }}" class="card-img-top d-block w-100 " alt="...">
                        ...
                        <a href="{{route('choosecharityDonation',[app()->getLocale(), $charitydeductionproject->project_code ] )}}">
                            ...
                            <h6 class="CLR text-center mt-1"> سيتم الخصم من حسابك :</h6>
                                  <div class="col-3 p-0"><button type="button" id="6_month_{{$key}}" data-interval_{{$key}}="180" class="btn w-100 BTN-2 active rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'6_month_{{$key}}')">6 شهور</button></div>
								   <div class="col-3 p-0"><button type="button" id="3_month_{{$key}}" data-interval_{{$key}}="90"  class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'3_month_{{$key}}')">3 شهور</button></div>
								   <div class="col-3 p-0"><button type="button" id="2_month_{{$key}}" data-interval_{{$key}}="60" class="btn w-100 BTN-2 rounded-0 intervaldays_{{$key}}" onclick="showmontedata({{$key}},'2_month_{{$key}}')">2 شهور</button></div>
                          ...
                          <div class="row text-center mt-3">
                            ...
                            <div class="row mt-3">   
                            <div class="col-12"><button type="button" class="btn w-100 BTN-1" onclick="opencardmodal({{$key}})">تبرع الآن <i class="fa-solid fa-money-bill-wave"></i></button></div>
                            </div>
