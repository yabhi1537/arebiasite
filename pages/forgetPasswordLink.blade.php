...
<section id="ForgotPassword" class="container mt-3">
	...
	@endif
    <div class="row p-3">
        <h5 class="mt-4" style="font-size: 25px; font-weight: 700; color: #6c757d;">إعادة تعيين كلمة المرور</h5>
        <div class="col-md-10">
                      <form autocomplete="off" action="{{ route('reset.password.post',app()->getLocale()) }}" method="POST">
                          ...
                          <input type="hidden" name="token" value="{{ $token }}">
                           ...
                           <div class="row mt-3 donar_detailForm">
							  <div class="mb-3">
								<p class="panel_titleDetail mb-1">عنوان البريد الإلكتروني</p>
                         ...
                         <div class="text-center"> 
                                <button type="submit" class="btn BTN-1 btn-sm">  إعادة تعيين كلمة المرور</button>
