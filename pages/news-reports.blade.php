      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-12 col-md-11 col-lg-9 col-xl-7 col-xxl-6 text-center text-white mt-5 pt-5">
            <h1 class="display-3 fw-bold mb-3 mt-5">{{$newsreportheader->title_ar}}</h1>
            <p class=" mb-5">{{$newsreportheader->description_ar}}</p>
          </div>
        </div>
      </div>
    </div>  
...
<section id="mediaReports" class="container mt-5">
  <div class="mediaReports " style="margin:0 auto; width: 95%;">
    <div class="row sectionHeading mb-3">
      <h1 class="text-center CLR">أخبارنا وتقاريرنا</h1>
    ...
    <div class="row">
      <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="pills-completed-tab" data-bs-toggle="pill" data-bs-target="#pills-completed" type="button" role="tab" aria-controls="pills-completed" aria-selected="true">تقارير المشاريع</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="pills-seasonal-tab" data-bs-toggle="pill" data-bs-target="#pills-seasonal" type="button" role="tab" aria-controls="pills-seasonal" aria-selected="false">الأخبار العامة</button>
        </li>
      </ul>
            ...
            @forelse ($projectreportnewss as $key => $news)  	
				  <div class="col-md-3 hover" >
					<div class="snip1527 ">
					  ...
					  <figcaption>
						<p class="cardDetail"> <span> {{ $news->city_ar }} </span> <i class="fa-solid fa-location-dot"></i> <span> {{ date('H:i A', strtotime($news->time)) }} </span> <i class="fa-solid fa-clock"></i></p>  
						<h6>{{ $news->title_ar }}</h6>
					  </figcaption>
