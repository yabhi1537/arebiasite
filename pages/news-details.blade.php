      ...
      <div class="row mt-4">
         <div class="col-md-9">
             <div class="news_Details ">
                ...
                <h4 class="fw-bold">{{ $news_details->title_ar }}</h4>
                <p style="font-size: 15px; text-align: justify;">{!! $news_details->description_ar !!}</p>
             </div>
         </div>
         <div class="col-md-3"> 
           <h4 class="fw-bold border-bottom pb-3">أخبار أخرى</h4>
           ...
           <div class="side_wrrapernews mt-3">
            <a href="{{route('newsdetails',[app()->getLocale(), encrypt($news->newsid)] )}}">
             ...
             <h6 class="fw-bold">{{ $news->title_ar }}</h6>
            </a>
           </div>
           @endforeach
