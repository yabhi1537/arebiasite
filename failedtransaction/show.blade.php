                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="wrapper d-block d-sm-flex align-items-center justify-content-between">
                                <h4 class="card-title mb-0">Show Failed Transactions</h4>
                            ...
                            <div class="wrapper">
                             ...
                             <div class="text-center mt-3 "> <a href="{{ route('failedtransaction') }}" class="btn btn-outline-danger w-25">Back</a></div>
