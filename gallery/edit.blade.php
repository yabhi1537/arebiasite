...
<div class="card-body mt-0">
    ...
    <form id="baseForm" name="baseForm" class="forms-sample" method="POST"
        action="{{ route('gallery.update',$gallery->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <div class="form-group">
            <label for="email">Media Title</label>
            <input type="text" value="{{ $gallery->title}}" class="form-control required" id="title" placeholder="Name"
                name="title">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{ $gallery->title_ar}}" class="form-control required" id="title_ar" placeholder="Name" name="title_ar">
        ...
        <div class="form-group" id="row_dim">
            ...
            <input type="hidden" value="{{ $gallery->video_image}}" name="video_images" class="form-control file-upload-info" >
        ...
        <div class="form-group" id="showurl">
            ...
            <input type="hidden" value="{{ $gallery->video_image}}" name="video_imaged" class="form-control file-upload-info" >
